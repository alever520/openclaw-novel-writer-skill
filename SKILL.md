...
在正式创作前，先根据 `references/outline-template.md` 中对应章节的规划，生成本章大纲，格式如下：
...
【场景序列】
1. [场景名]: [人物/地点/核心事件，1-2句]
2. [场景名]: [人物/地点/核心事件，1-2句]
3. ...
...
生成大纲后，**向用户确认**：
> 以上是第X章的创作大纲，是否有修改建议？确认后开始创作正文。

**大纲确认循环**：
- 若用户提出修改意见 → 按意见修改大纲 → 再次展示 → 再次确认
- 此类大纲修改建议**无需写入 reader-feedback.md**，除非用户明确要求
- 用户确认（"可以"/"没问题"/"开始写"等）后，进入步骤1
